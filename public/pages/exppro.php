	...
	<body class="over-x-hid">
		...
		<div id="exppro-content">
			<div class="exppro-button">
				<div id="E-button0" class="circle-base button-middle hvr-radial-out-gre">
					<label class="button-label"><?php echo EXPPRO1 ?></label>
				</div>
			</div>
			<div id="exppro0" class="triangle-box">
				<div class=triangle>
			...
			<div class="triangle-text" data-link="exppro0">
				<h1>
					...
					Curabitur non lacus dapibus, maximus erat et, suscipit leo. Fusce pulvinar vel felis eget iaculis. Sed condimentum libero at tortor porttitor, eu volutpat est convallis. Vivamus mattis nisi a dictum auctor. Nulla sed eros erat. Pellentesque ac lacus sed nulla hendrerit ornare. Donec fringilla elementum nulla sed scelerisque. Integer vel condimentum augue, at semper augue. Donec congue, turpis eu accumsan luctus, felis nisl consectetur dolor, eget ornare diam ante efficitur ex. Curabitur condimentum vulputate lectus. Etiam id consectetur leo, in imperdiet est. Viveuismod sapien vulputate sit amet. Fusce mollis arcu vel dignissim vehicula.
					Curabitur non lacus dapibus, maximus erat et, suscipit leo. Fusce pulvinar vel felis eget iaculis. Sed condimentum libero at tortor porttitor, eu volutpat est convallis. Vivamus mattis nisi a dictum auctor. Nulla sed eros erat. Pellentesque ac lacus sed nulla hendrerit ornare. Donec fringilla elementum nulla sed scelerisque. Integer vel condimentum augue, at semper augue. Donec congue, turpis eu accumsan luctus, felis nisl consectetur dolor, eget ornare diam ante efficitur ex. Curabitur condimentum vulputate lectus. Etiam id consectetur leo, in imperdiet est. Vivamus rutrum lacus dolor, ut mollis turpis feugiat et. Phasellus auctor suscipit mauris, vel euismod sapien vulputate sit amet. Fusce mollis arcu vel dignissim vehicula.amus rutrum lacus dolor, ut mollis turpis feugiat et. Phasellus auctor suscipit mauris, vel 
				</h1>
			</div>
			<div class="exppro-button">
				<div id="E-button1" class="circle-base button-middle hvr-radial-out-ora">
			...
			<div id="exppro2" class="triangle-box exppro-last" data="last">
				<div class=triangle>
					<svg viewBox="0 0 100 25">
	  					<polygon points="100 0, 100 25, 0 25"></polygon>
					</svg>
				</div>
...
$(document).ready(function(){
	$(".button-middle").click(function(){
		toggleExppro($(this).parent().next(".triangle-box").attr('id'));
